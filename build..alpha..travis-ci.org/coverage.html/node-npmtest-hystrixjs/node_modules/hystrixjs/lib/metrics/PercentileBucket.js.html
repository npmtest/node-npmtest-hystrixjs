...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-hystrixjs/node_modules/hystrixjs/lib/metrics/PercentileBucket.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-hystrixjs/node_modules/hystrixjs/lib/metrics/PercentileBucket.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-hystrixjs/node_modules/hystrixjs/lib/metrics/</a> &#187; PercentileBucket.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >    function PercentileBucket(windowStart) {</span>
<span class="cstat-no" title="statement not covered" >        _classCallCheck(this, PercentileBucket);</span>
&nbsp;
...
&nbsp;
    _createClass(PercentileBucket, [{
        key: "addValue",
        value: <span class="fstat-no" title="function not covered" >function addValue() {</span>
<span class="cstat-no" title="statement not covered" >            var value = arguments.length &lt;= 0 || arguments[0] === undefined ? 0 : arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.bucketValues.push(value);</span>
        }
    }, {
        key: "values",
        get: <span class="fstat-no" title="function not covered" >function get() {</span>
<span class="cstat-no" title="statement not covered" >            return this.bucketValues;</span>
        }
    }]);
&nbsp;
